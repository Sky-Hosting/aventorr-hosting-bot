...
module.exports = async (client, interaction) => {
    if(interaction.message.channelId === config.channelID.ticketChannel && interaction.customId === '968261503335661579'){
        ...
        const WelcomToTicket = await channel.send({content: `<@${interaction.user.id}>`, embeds:[
            ...
            .setColor(`BLUE`)
            .setDescription(`Welcome to Sky's Hosting  support, how can we help you?\nPlease describe your problem as much as possible \:D`)
